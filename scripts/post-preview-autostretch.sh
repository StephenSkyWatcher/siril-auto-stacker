...
CUR_POSTPROCESS_SCRIPT="/tmp/tmp.post-preview-autostretch.ssf"
...
cat $STACK_HOME/templates/post-preview-autostretch.ssf | sed -e 's/%FILE%/'"$STACKED_LIGHTS_FILE"'/' > $CUR_POSTPROCESS_SCRIPT
